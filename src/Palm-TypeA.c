...
extern void F77_NAME(xqgausaf)(double*, double*, int*, double*, double*, double*, double*, double*, double*, double*, double*, int*, int*, double*, double*);

SEXP palmA(SEXP x, SEXP y, SEXP np, SEXP delta, SEXP ty, SEXP x2, SEXP amu, SEXP anu, SEXP a, SEXP s1, SEXP s2,  SEXP m, SEXP jmax)
{
