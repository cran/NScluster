      subroutine simCf(ix,iy,iz,ty,amu1,amu2,anu1,anu2,s1,s2,
...
cx      dimension ncl1(mmax), ncl2(mmax)
      integer :: ix, iy, iz, m1, m2, mmax, nmax, ncl1(mmax), ncl2(mmax),
     1           ier
      real(8) :: ty, amu1, amu2, anu1, anu2, s1, s2, x1(mmax), y1(mmax),
...
cc          call  Pois(anu2,ncl2)
          call  Pois(anu2,ncl2(i),ix,iy,iz)
c---
          if( ncl2(i) > nmax ) then
             ier=-22
             return
