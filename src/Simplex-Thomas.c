...
extern void F77_NAME(smplxthomf)(double*, double*, int*, double*, double*,
                                 double*, double*, double*, int*, int*, int*,
                                 double*, double*,double*, double*, double*,
                                 int*, int*, int*, int*);

SEXP smplxThom(SEXP x, SEXP y, SEXP np, SEXP ty, SEXP sclmu, SEXP sclnu,
               SEXP scls, SEXP eps, SEXP itmax, SEXP itmax1, SEXP ipmax,
               SEXP ipflg)
{
