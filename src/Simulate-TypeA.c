...
extern void F77_NAME(simaf)(int*, double*, double*, double*, double*, double*,
                            double*, int*, int*, double*, double*, double*,
                            double*, int*, int*, int*);

SEXP simA(SEXP ix, SEXP ty, SEXP amu, SEXP anu, SEXP a, SEXP sig1, SEXP sig2,
          SEXP pmax, SEXP omax)
{
  ...
  y = R_NilValue, xcl = R_NilValue, ycl = R_NilValue, ier = R_NilValue;
    ...
    F77_CALL(simaf) (i1,d1,d2,d3,d4,d5,d6,i2,i3,d7,d8,d9,d10,i4,i5,i6);
