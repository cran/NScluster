...
extern void F77_NAME(simbf)(int*, double*, double*, double*, double*, double*,
                            double*, int*,  int*, double*, double*, double*,
                            double*, int*,  int*, double*, double*, double*,
                            double*, int*, int*, int*);

SEXP simB(SEXP ix, SEXP ty, SEXP amu, SEXP anu, SEXP a, SEXP sig1, SEXP sig2,
          SEXP pmax, SEXP omax)
{
  ...
  yy2 = R_NilValue, ier = R_NilValue;
    ...
    F77_CALL(simbf) (i1,d1,d2,d3,d4,d5,d6,i2,i3,d7,d8,d9,d10,i4,i5,d11,d12,d13,d14,i6,i7,i8);
