...
extern void F77_NAME(simipf)(int*, double*, double*, double*, double*, double*,
                             int*, int*, double*, double*, double*, double*,
                             int*, int*, int*);

SEXP simIP(SEXP ix, SEXP ty, SEXP amu, SEXP anu, SEXP p, SEXP c, SEXP pmax,
           SEXP omax)
{
  ...
  y = R_NilValue, xcl = R_NilValue, ycl = R_NilValue, ier = R_NilValue;
    ...
    F77_CALL(simipf) (i1,d1,d2,d3,d4,d5,i2,i3,d6,d7,d8,d9,i4,i5,i6);
